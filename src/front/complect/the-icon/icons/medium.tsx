...
export const IconMediumStrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumDuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumTwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumSolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumBulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumStrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconMediumSolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}

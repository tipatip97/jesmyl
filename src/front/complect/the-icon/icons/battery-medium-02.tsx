...
export const IconBatteryMedium02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-duotone-rounded IconBatteryMedium02DuotoneRounded"
    >
      <path 
...
export const IconBatteryMedium02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-twotone-rounded IconBatteryMedium02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryMedium02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-solid-rounded IconBatteryMedium02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBatteryMedium02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-bulk-rounded IconBatteryMedium02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconBatteryMedium02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-stroke-sharp IconBatteryMedium02StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryMedium02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-02-solid-sharp IconBatteryMedium02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfBatteryMedium02: TheIconSelfPack = {
  name: 'BatteryMedium02',
  StrokeRounded: IconBatteryMedium02StrokeRounded,
  DuotoneRounded: IconBatteryMedium02DuotoneRounded,
  TwotoneRounded: IconBatteryMedium02TwotoneRounded,
  SolidRounded: IconBatteryMedium02SolidRounded,
  BulkRounded: IconBatteryMedium02BulkRounded,
  StrokeSharp: IconBatteryMedium02StrokeSharp,
  SolidSharp: IconBatteryMedium02SolidSharp,
};
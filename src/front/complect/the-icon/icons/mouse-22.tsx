...
export const IconMouse22DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-duotone-rounded IconMouse22DuotoneRounded"
    >
      <path 
...
export const IconMouse22TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-twotone-rounded IconMouse22TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconMouse22SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-solid-rounded IconMouse22SolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconMouse22BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-bulk-rounded IconMouse22BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconMouse22StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-stroke-sharp IconMouse22StrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconMouse22SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-22-solid-sharp IconMouse22SolidSharp"
    >
      <path 
        d={d.d9} 
        fill="var(--icon-fill)" 
...
export const iconPackOfMouse22: TheIconSelfPack = {
  name: 'Mouse22',
  StrokeRounded: IconMouse22StrokeRounded,
  DuotoneRounded: IconMouse22DuotoneRounded,
  TwotoneRounded: IconMouse22TwotoneRounded,
  SolidRounded: IconMouse22SolidRounded,
  BulkRounded: IconMouse22BulkRounded,
  StrokeSharp: IconMouse22StrokeSharp,
  SolidSharp: IconMouse22SolidSharp,
};
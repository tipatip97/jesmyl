...
export const IconMouseLeftClick04DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-duotone-rounded IconMouseLeftClick04DuotoneRounded"
    >
      <path 
...
export const IconMouseLeftClick04TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-twotone-rounded IconMouseLeftClick04TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconMouseLeftClick04SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-solid-rounded IconMouseLeftClick04SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconMouseLeftClick04BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-bulk-rounded IconMouseLeftClick04BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconMouseLeftClick04StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-stroke-sharp IconMouseLeftClick04StrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconMouseLeftClick04SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="mouse-left-click-04-solid-sharp IconMouseLeftClick04SolidSharp"
    >
      <path 
        d={d.d11} 
        fill="var(--icon-fill)" 
...
export const iconPackOfMouseLeftClick04: TheIconSelfPack = {
  name: 'MouseLeftClick04',
  StrokeRounded: IconMouseLeftClick04StrokeRounded,
  DuotoneRounded: IconMouseLeftClick04DuotoneRounded,
  TwotoneRounded: IconMouseLeftClick04TwotoneRounded,
  SolidRounded: IconMouseLeftClick04SolidRounded,
  BulkRounded: IconMouseLeftClick04BulkRounded,
  StrokeSharp: IconMouseLeftClick04StrokeSharp,
  SolidSharp: IconMouseLeftClick04SolidSharp,
};
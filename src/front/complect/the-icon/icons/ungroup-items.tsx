...
const d: Record<string, string> = {
  ...
  d12: 'M1.25 20C1.25 18.4812 2.48122 17.25 4 17.25C5.51878 17.25 6.75 18.4812 6.75 20C6.75 21.5188 5.51878 22.75 4 22.75C2.48122 22.75 1.25 21.5188 1.25 20Z',
  d13: 'M16.5 7.5H7.5V10.5H16.5V7.5Z',
  d14: 'M16.5 13.5H7.5V16.5H16.5V13.5Z',
  d15: 'M7.5 7.5H16.5V11.25H7.5V7.5Z',
  d16: 'M7.5 12.75H16.5V16.5H7.5V12.75Z',
};

export const IconUngroupItemsStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-stroke-rounded IconUngroupItemsStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconUngroupItemsDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-duotone-rounded IconUngroupItemsDuotoneRounded"
    >
      <path 
...
export const IconUngroupItemsTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-twotone-rounded IconUngroupItemsTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconUngroupItemsSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-solid-rounded IconUngroupItemsSolidRounded"
    >
      <path 
        d={d.d7} 
        fill="var(--icon-fill)" 
...
export const IconUngroupItemsBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-bulk-rounded IconUngroupItemsBulkRounded"
    >
      <path 
        d={d.d7} 
        fill="var(--icon-fill)" 
...
export const IconUngroupItemsStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-stroke-sharp IconUngroupItemsStrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconUngroupItemsSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="ungroup-items-solid-sharp IconUngroupItemsSolidSharp"
    >
      <path 
        d={d.d9} 
        fill="var(--icon-fill)" 
...
export const iconPackOfUngroupItems: TheIconSelfPack = {
  name: 'UngroupItems',
  StrokeRounded: IconUngroupItemsStrokeRounded,
  DuotoneRounded: IconUngroupItemsDuotoneRounded,
  TwotoneRounded: IconUngroupItemsTwotoneRounded,
  SolidRounded: IconUngroupItemsSolidRounded,
  BulkRounded: IconUngroupItemsBulkRounded,
  StrokeSharp: IconUngroupItemsStrokeSharp,
  SolidSharp: IconUngroupItemsSolidSharp,
};
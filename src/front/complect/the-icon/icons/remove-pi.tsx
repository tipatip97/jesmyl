...
const d: Record<string, string> = {
  ...
  d4: 'M18.3333 17.5H15.6667M21 17.5C21 19.7091 19.2091 21.5 17 21.5C14.7909 21.5 13 19.7091 13 17.5C13 15.2909 14.7909 13.5 17 13.5C19.2091 13.5 21 15.2909 21 17.5Z',
  ...
  d13: 'M12.25 17.25C12.25 14.6266 14.3766 12.5 17 12.5C19.6234 12.5 21.75 14.6266 21.75 17.25C21.75 19.8734 19.6234 22 17 22C14.3766 22 12.25 19.8734 12.25 17.25ZM19.0827 18H14.916V16.5H19.0827V18Z',
};

export const IconRemovePiStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-stroke-rounded IconRemovePiStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconRemovePiDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-duotone-rounded IconRemovePiDuotoneRounded"
    >
      <path 
...
export const IconRemovePiTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-twotone-rounded IconRemovePiTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconRemovePiSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-solid-rounded IconRemovePiSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconRemovePiBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-bulk-rounded IconRemovePiBulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconRemovePiStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-stroke-sharp IconRemovePiStrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconRemovePiSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="remove-pi-solid-sharp IconRemovePiSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfRemovePi: TheIconSelfPack = {
  name: 'RemovePi',
  StrokeRounded: IconRemovePiStrokeRounded,
  DuotoneRounded: IconRemovePiDuotoneRounded,
  TwotoneRounded: IconRemovePiTwotoneRounded,
  SolidRounded: IconRemovePiSolidRounded,
  BulkRounded: IconRemovePiBulkRounded,
  StrokeSharp: IconRemovePiStrokeSharp,
  SolidSharp: IconRemovePiSolidSharp,
};
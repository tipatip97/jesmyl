...
const d: Record<string, string> = {
  ...
  d2: 'M16 9.5L8 9.5M13.5 14.5H10.5',
  ...
  d5: 'M8 8.5C7.44772 8.5 7 8.94772 7 9.5C7 10.0523 7.44772 10.5 8 10.5H16C16.5523 10.5 17 10.0523 17 9.5C17 8.94772 16.5523 8.5 16 8.5H8ZM10.5 13.5C9.94772 13.5 9.5 13.9477 9.5 14.5C9.5 15.0523 9.94772 15.5 10.5 15.5H13.5C14.0523 15.5 14.5 15.0523 14.5 14.5C14.5 13.9477 14.0523 13.5 13.5 13.5H10.5Z',
  d6: 'M3 22L3 2L21 2.01302L21 22H3Z',
  d7: 'M17 9.5L7 9.5M14.5 14.5H9.5',
  d8: 'M2.99946 1.25635C2.58545 1.25665 2.25 1.59235 2.25 2.00635V21.9933C2.25 22.4075 2.58579 22.7433 3 22.7433L21 22.7498C21.4142 22.7498 21.75 22.414 21.75 21.9998V2.01282C21.75 1.59882 21.4145 1.26312 21.0005 1.26282L2.99946 1.25635ZM17 8.49988H7V10.4999H17V8.49988ZM14.5 13.4999H9.5V15.4999H14.5V13.4999Z',
};

export const IconAlignBoxMiddleCenterStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-stroke-rounded IconAlignBoxMiddleCenterStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconAlignBoxMiddleCenterDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-duotone-rounded IconAlignBoxMiddleCenterDuotoneRounded"
    >
      <path 
...
export const IconAlignBoxMiddleCenterTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-twotone-rounded IconAlignBoxMiddleCenterTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxMiddleCenterSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-solid-rounded IconAlignBoxMiddleCenterSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconAlignBoxMiddleCenterBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-bulk-rounded IconAlignBoxMiddleCenterBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconAlignBoxMiddleCenterStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-stroke-sharp IconAlignBoxMiddleCenterStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxMiddleCenterSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-middle-center-solid-sharp IconAlignBoxMiddleCenterSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfAlignBoxMiddleCenter: TheIconSelfPack = {
  name: 'AlignBoxMiddleCenter',
  StrokeRounded: IconAlignBoxMiddleCenterStrokeRounded,
  DuotoneRounded: IconAlignBoxMiddleCenterDuotoneRounded,
  TwotoneRounded: IconAlignBoxMiddleCenterTwotoneRounded,
  SolidRounded: IconAlignBoxMiddleCenterSolidRounded,
  BulkRounded: IconAlignBoxMiddleCenterBulkRounded,
  StrokeSharp: IconAlignBoxMiddleCenterStrokeSharp,
  SolidSharp: IconAlignBoxMiddleCenterSolidSharp,
};
...
export const IconKissingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-duotone-rounded IconKissingDuotoneRounded"
    >
      <path 
...
export const IconKissingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-twotone-rounded IconKissingTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconKissingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-solid-rounded IconKissingSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconKissingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-bulk-rounded IconKissingBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d9} 
...
export const IconKissingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-stroke-sharp IconKissingStrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconKissingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="kissing-solid-sharp IconKissingSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfKissing: TheIconSelfPack = {
  name: 'Kissing',
  StrokeRounded: IconKissingStrokeRounded,
  DuotoneRounded: IconKissingDuotoneRounded,
  TwotoneRounded: IconKissingTwotoneRounded,
  SolidRounded: IconKissingSolidRounded,
  BulkRounded: IconKissingBulkRounded,
  StrokeSharp: IconKissingStrokeSharp,
  SolidSharp: IconKissingSolidSharp,
};
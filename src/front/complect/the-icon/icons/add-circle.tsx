...
export const IconAddCircleStrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-stroke-rounded IconAddCircleStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconAddCircleDuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-duotone-rounded IconAddCircleDuotoneRounded"
    >
      <path 
...
export const IconAddCircleTwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-twotone-rounded IconAddCircleTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconAddCircleSolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-solid-rounded IconAddCircleSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconAddCircleBulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-bulk-rounded IconAddCircleBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconAddCircleStrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-stroke-sharp IconAddCircleStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconAddCircleSolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
      name="add-circle-solid-sharp IconAddCircleSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfAddCircle: TheIconSelfPack = {
  name: 'AddCircle',
  StrokeRounded: IconAddCircleStrokeRounded,
  DuotoneRounded: IconAddCircleDuotoneRounded,
  TwotoneRounded: IconAddCircleTwotoneRounded,
  SolidRounded: IconAddCircleSolidRounded,
  BulkRounded: IconAddCircleBulkRounded,
  StrokeSharp: IconAddCircleStrokeSharp,
  SolidSharp: IconAddCircleSolidSharp,
};
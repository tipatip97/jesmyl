...
const d: Record<string, string> = {
  ...
  d8: 'M21.0006 2.99902L14.0006 9.99902M21.0006 9.99902L14.0006 2.99902',
  ...
  d11: 'M17.5 5.08586L20.2928 2.29297L21.7071 3.70718L18.9142 6.50008L21.7071 9.29297L20.2928 10.7072L17.5 7.91429L14.7071 10.7072L13.2928 9.29297L16.0857 6.50008L13.2928 3.70718L14.7071 2.29297L17.5 5.08586Z',
};

export const IconCallEnd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-stroke-rounded IconCallEnd01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallEnd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-duotone-rounded IconCallEnd01DuotoneRounded"
    >
      <g 
...
export const IconCallEnd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-twotone-rounded IconCallEnd01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallEnd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-solid-rounded IconCallEnd01SolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallEnd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-bulk-rounded IconCallEnd01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallEnd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-stroke-sharp IconCallEnd01StrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallEnd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-end-01-solid-sharp IconCallEnd01SolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallEnd01: TheIconSelfPack = {
  name: 'CallEnd01',
  StrokeRounded: IconCallEnd01StrokeRounded,
  DuotoneRounded: IconCallEnd01DuotoneRounded,
  TwotoneRounded: IconCallEnd01TwotoneRounded,
  SolidRounded: IconCallEnd01SolidRounded,
  BulkRounded: IconCallEnd01BulkRounded,
  StrokeSharp: IconCallEnd01StrokeSharp,
  SolidSharp: IconCallEnd01SolidSharp,
};
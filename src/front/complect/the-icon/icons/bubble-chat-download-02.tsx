...
const d: Record<string, string> = {
  ...
  d9: 'M15.9954 7L18.9954 10L21.9954 7M18.9954 2V9.46952',
  d10: 'M11.9909 12H11.9999M7.99536 12H8.00433',
  d11: 'M21.9978 11.4989C21.9978 16.7505 17.5216 21.0077 12 21.0077C10.5758 21.0077 9.22111 20.7245 7.99487 20.214L4.019 21.9991C4.0113 22.0026 4.00305 21.9955 4.00525 21.9874L5.00624 18.2904C3.16355 16.5092 2.0022 14.178 2.0022 11.4989C2.0022 5.99859 7.06188 0.988541 14.0051 2.17603',
  d12: 'M19.0429 10.6641L22.75 6.95696L21.3358 5.54274L20.0429 6.83563V1.24985H18.0429V6.83564L16.75 5.54274L15.3358 6.95696L19.0429 10.6641Z',
...
export const IconBubbleChatDownload02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-stroke-rounded IconBubbleChatDownload02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconBubbleChatDownload02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-duotone-rounded IconBubbleChatDownload02DuotoneRounded"
    >
      <path 
...
export const IconBubbleChatDownload02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-twotone-rounded IconBubbleChatDownload02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconBubbleChatDownload02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-solid-rounded IconBubbleChatDownload02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBubbleChatDownload02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-bulk-rounded IconBubbleChatDownload02BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBubbleChatDownload02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-stroke-sharp IconBubbleChatDownload02StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconBubbleChatDownload02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="bubble-chat-download-02-solid-sharp IconBubbleChatDownload02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfBubbleChatDownload02: TheIconSelfPack = {
  name: 'BubbleChatDownload02',
  StrokeRounded: IconBubbleChatDownload02StrokeRounded,
  DuotoneRounded: IconBubbleChatDownload02DuotoneRounded,
  TwotoneRounded: IconBubbleChatDownload02TwotoneRounded,
  SolidRounded: IconBubbleChatDownload02SolidRounded,
  BulkRounded: IconBubbleChatDownload02BulkRounded,
  StrokeSharp: IconBubbleChatDownload02StrokeSharp,
  SolidSharp: IconBubbleChatDownload02SolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d2: 'M15.7 17.5H19.3M17.5 19.3V15.7M22 17.5C22 19.9853 19.9853 22 17.5 22C15.0147 22 13 19.9853 13 17.5C13 15.0147 15.0147 13 17.5 13C19.9853 13 22 15.0147 22 17.5Z',
  ...
  d8: 'M17 11.25C13.8244 11.25 11.25 13.8244 11.25 17C11.25 20.1756 13.8244 22.75 17 22.75C20.1756 22.75 22.75 20.1756 22.75 17C22.75 13.8244 20.1756 11.25 17 11.25ZM18 19.5V18H19.5V16H18V14.5H16V16H14.5V18H16V19.5H18Z',
};

export const IconCursorAddSelection02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-stroke-rounded IconCursorAddSelection02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCursorAddSelection02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-duotone-rounded IconCursorAddSelection02DuotoneRounded"
    >
      <path 
...
export const IconCursorAddSelection02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-twotone-rounded IconCursorAddSelection02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCursorAddSelection02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-solid-rounded IconCursorAddSelection02SolidRounded"
    >
      <path 
        d={d.d3} 
        fill="var(--icon-fill)" 
...
export const IconCursorAddSelection02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-bulk-rounded IconCursorAddSelection02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d3} 
...
export const IconCursorAddSelection02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-stroke-sharp IconCursorAddSelection02StrokeSharp"
    >
      <path 
        d={d.d5} 
        stroke="var(--icon-stroke)" 
...
export const IconCursorAddSelection02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-02-solid-sharp IconCursorAddSelection02SolidSharp"
    >
      <path 
        d={d.d7} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCursorAddSelection02: TheIconSelfPack = {
  name: 'CursorAddSelection02',
  StrokeRounded: IconCursorAddSelection02StrokeRounded,
  DuotoneRounded: IconCursorAddSelection02DuotoneRounded,
  TwotoneRounded: IconCursorAddSelection02TwotoneRounded,
  SolidRounded: IconCursorAddSelection02SolidRounded,
  BulkRounded: IconCursorAddSelection02BulkRounded,
  StrokeSharp: IconCursorAddSelection02StrokeSharp,
  SolidSharp: IconCursorAddSelection02SolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d2: 'M13 5.5L21 5.5M13 5.5C13 6.20023 14.9943 7.50847 15.5 8M13 5.5C13 4.79977 14.9943 3.49153 15.5 3',
  ...
  d8: 'M20.9996 5.99902H13.4776M15.9996 8.99902L12.9996 5.99902L15.9996 2.99902',
  ...
  d11: 'M15.2932 2.29297L16.7074 3.70718L15.4145 5.00008L21.0003 5.00008V7.00008L15.4145 7.00008L16.7074 8.29297L15.2932 9.70718L11.5861 6.00008L15.2932 2.29297Z',
};

export const IconCallIncoming01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-stroke-rounded IconCallIncoming01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallIncoming01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-duotone-rounded IconCallIncoming01DuotoneRounded"
    >
      <g 
...
export const IconCallIncoming01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-twotone-rounded IconCallIncoming01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallIncoming01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-solid-rounded IconCallIncoming01SolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallIncoming01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-bulk-rounded IconCallIncoming01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallIncoming01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-stroke-sharp IconCallIncoming01StrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallIncoming01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-incoming-01-solid-sharp IconCallIncoming01SolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallIncoming01: TheIconSelfPack = {
  name: 'CallIncoming01',
  StrokeRounded: IconCallIncoming01StrokeRounded,
  DuotoneRounded: IconCallIncoming01DuotoneRounded,
  TwotoneRounded: IconCallIncoming01TwotoneRounded,
  SolidRounded: IconCallIncoming01SolidRounded,
  BulkRounded: IconCallIncoming01BulkRounded,
  StrokeSharp: IconCallIncoming01StrokeSharp,
  SolidSharp: IconCallIncoming01SolidSharp,
};
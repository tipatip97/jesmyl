...
const d: Record<string, string> = {
  ...
  d3: 'M9.5 16.5L9.5 10.5',
  d4: 'M14.5 16.5L14.5 10.5',
  ...
  d10: 'M19.5825 15.6564C19.5058 16.9096 19.4449 17.9041 19.3202 18.6984C19.1922 19.5131 18.9874 20.1915 18.5777 20.7849C18.2029 21.3278 17.7204 21.786 17.1608 22.1303C16.5491 22.5067 15.8661 22.6713 15.0531 22.75L8.92739 22.7499C8.1135 22.671 7.42972 22.5061 6.8176 22.129C6.25763 21.7841 5.77494 21.3251 5.40028 20.7813C4.99073 20.1869 4.78656 19.5075 4.65957 18.6917C4.53574 17.8962 4.47623 16.9003 4.40122 15.6453L3.75 4.75H20.25L19.5825 15.6564Z',
  d11: 'M9.5 17.9648C9.08579 17.9648 8.75 17.6291 8.75 17.2148L8.75 11.2148C8.75 10.8006 9.08579 10.4648 9.5 10.4648C9.91421 10.4648 10.25 10.8006 10.25 11.2148L10.25 17.2148C10.25 17.6291 9.91421 17.9648 9.5 17.9648Z',
  d12: 'M14.5 10.4648C14.9142 10.4648 15.25 10.8006 15.25 11.2148L15.25 17.2148C15.25 17.6291 14.9142 17.9648 14.5 17.9648C14.0858 17.9648 13.75 17.6291 13.75 17.2148L13.75 11.2148C13.75 10.8006 14.0858 10.4648 14.5 10.4648Z',
  d13: 'M19.5 5.5L18.5 22H5.5L4.5 5.5',
  d14: 'M2 5.5H8M22 5.5H16M16 5.5L14.5 2H9.5L8 5.5M16 5.5H8',
  ...
  d16: 'M19.2492 22.0454L20.2492 5.54541H3.75195L4.75195 22.0454C4.77595 22.4413 5.10399 22.75 5.50058 22.75H18.5006C18.8972 22.75 19.2252 22.4413 19.2492 22.0454ZM10.501 17V11H8.50098L8.50098 17H10.501ZM15.501 17V11H13.501V17H15.501Z',
};

export const IconDelete02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-stroke-rounded IconDelete02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconDelete02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-duotone-rounded IconDelete02DuotoneRounded"
    >
      <path 
...
export const IconDelete02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-twotone-rounded IconDelete02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconDelete02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-solid-rounded IconDelete02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconDelete02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-bulk-rounded IconDelete02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d10} 
...
export const IconDelete02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-stroke-sharp IconDelete02StrokeSharp"
    >
      <path 
        d={d.d13} 
        stroke="var(--icon-stroke)" 
...
export const IconDelete02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delete-02-solid-sharp IconDelete02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfDelete02: TheIconSelfPack = {
  name: 'Delete02',
  StrokeRounded: IconDelete02StrokeRounded,
  DuotoneRounded: IconDelete02DuotoneRounded,
  TwotoneRounded: IconDelete02TwotoneRounded,
  SolidRounded: IconDelete02SolidRounded,
  BulkRounded: IconDelete02BulkRounded,
  StrokeSharp: IconDelete02StrokeSharp,
  SolidSharp: IconDelete02SolidSharp,
};
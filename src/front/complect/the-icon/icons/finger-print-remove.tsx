...
const d: Record<string, string> = {
  ...
  d11: 'M16 16.5L17.4983 18M17.4983 18L19 19.5M17.4983 18L19 16.5M17.4983 18L16 19.5M21.5 18C21.5 20.2091 19.7091 22 17.5 22C15.2909 22 13.5 20.2091 13.5 18C13.5 15.7909 15.2909 14 17.5 14C19.7091 14 21.5 15.7909 21.5 18Z',
  d12: 'M5.92857 20.6058C3.85602 19.1977 2.5 16.8583 2.5 14.2103V9.75757C2.5 8.57285 2.77144 7.44988 3.25704 6.44444M9.35714 21.9236C10.2589 22.0493 11.1494 22.0167 12 21.8493M17.7301 6.41803C15.636 2.12432 9.89955 0.664089 5.92857 3.36201M18.5 9.33333V11.5M10.5 6C12.7091 6 14.5 7.8804 14.5 10.2M6.88493 8.4C6.63811 8.94555 6.5 9.55584 6.5 10.2V13.8C6.5 16.1196 8.29086 18 10.5 18C10.6693 18 10.8362 17.989 11 17.9675M10.5 10.5V13.5',
  d13: 'M17.5 13.25C14.8766 13.25 12.75 15.3766 12.75 18C12.75 20.6234 14.8766 22.75 17.5 22.75C20.1234 22.75 22.25 20.6234 22.25 18C22.25 15.3766 20.1234 13.25 17.5 13.25ZM18.4694 15.9697L17.4983 16.9397L16.53 15.9703L15.4688 17.0304L16.4376 18.0003L15.4688 18.9703L16.53 20.0304L17.4983 19.061L18.4694 20.031L19.5294 18.9697L18.5589 18.0003L19.5294 17.031L18.4694 15.9697Z',
  d14: 'M5.50919 2.74958C9.84631 -0.212497 16.1007 1.37059 18.4031 6.1162L16.6555 6.97302C14.8861 3.32613 9.98615 2.05504 6.60192 4.36633L5.50919 2.74958Z',
  d15: 'M1.75 9.80834C1.75 8.49953 2.04863 7.25709 2.58278 6.14538L4.3337 6.99546C3.92361 7.84898 3.69444 8.8015 3.69444 9.80834V14.16C3.69444 16.4036 4.83599 18.3959 6.60192 19.602L5.50919 21.2188C3.24516 19.6725 1.75 17.0921 1.75 14.16V9.80834Z',
  d16: 'M17.3056 11.16V8.37104H19.25V11.16H17.3056Z',
  d17: 'M9.25473 22.6662L9.52305 20.7303C10.1859 20.8231 10.8405 20.8152 11.4718 20.7196L12.2475 22.5629C11.2853 22.7655 10.2759 22.8092 9.25473 22.6662Z',
  d18: 'M13.4164 10.2411C13.4164 8.46847 12.0665 7.11378 10.4998 7.11378V5.15918C13.2287 5.15918 15.3609 7.47994 15.3609 10.2411H13.4164Z',
  d19: 'M5.63867 10.2411C5.63867 9.47101 5.8031 8.73738 6.09935 8.07916L7.87092 8.88485C7.68723 9.29297 7.58312 9.75221 7.58312 10.2411V13.7594C7.58312 15.5321 8.93311 16.8868 10.4998 16.8868V18.8414C7.77091 18.8414 5.63867 16.5206 5.63867 13.7594V10.2411Z',
  d20: 'M9.52734 10.5342V13.4661H11.4718V10.5342H9.52734Z',
};

export const IconFingerPrintRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-stroke-rounded IconFingerPrintRemoveStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconFingerPrintRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-duotone-rounded IconFingerPrintRemoveDuotoneRounded"
    >
      <path 
...
export const IconFingerPrintRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-twotone-rounded IconFingerPrintRemoveTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconFingerPrintRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-solid-rounded IconFingerPrintRemoveSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconFingerPrintRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-bulk-rounded IconFingerPrintRemoveBulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconFingerPrintRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-stroke-sharp IconFingerPrintRemoveStrokeSharp"
    >
      <path 
        d={d.d11} 
        stroke="var(--icon-stroke)" 
...
export const IconFingerPrintRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="finger-print-remove-solid-sharp IconFingerPrintRemoveSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfFingerPrintRemove: TheIconSelfPack = {
  name: 'FingerPrintRemove',
  StrokeRounded: IconFingerPrintRemoveStrokeRounded,
  DuotoneRounded: IconFingerPrintRemoveDuotoneRounded,
  TwotoneRounded: IconFingerPrintRemoveTwotoneRounded,
  SolidRounded: IconFingerPrintRemoveSolidRounded,
  BulkRounded: IconFingerPrintRemoveBulkRounded,
  StrokeSharp: IconFingerPrintRemoveStrokeSharp,
  SolidSharp: IconFingerPrintRemoveSolidSharp,
};
...
export const IconWorkflowSquare03StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-stroke-rounded IconWorkflowSquare03StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconWorkflowSquare03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-duotone-rounded IconWorkflowSquare03DuotoneRounded"
    >
      <path 
...
export const IconWorkflowSquare03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-twotone-rounded IconWorkflowSquare03TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconWorkflowSquare03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-solid-rounded IconWorkflowSquare03SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconWorkflowSquare03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-bulk-rounded IconWorkflowSquare03BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d8} 
...
export const IconWorkflowSquare03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-stroke-sharp IconWorkflowSquare03StrokeSharp"
    >
      <path 
        d={d.d13} 
        stroke="var(--icon-stroke)" 
...
export const IconWorkflowSquare03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="workflow-square-03-solid-sharp IconWorkflowSquare03SolidSharp"
    >
      <path 
        d={d.d18} 
        fill="var(--icon-fill)" 
...
export const iconPackOfWorkflowSquare03: TheIconSelfPack = {
  name: 'WorkflowSquare03',
  StrokeRounded: IconWorkflowSquare03StrokeRounded,
  DuotoneRounded: IconWorkflowSquare03DuotoneRounded,
  TwotoneRounded: IconWorkflowSquare03TwotoneRounded,
  SolidRounded: IconWorkflowSquare03SolidRounded,
  BulkRounded: IconWorkflowSquare03BulkRounded,
  StrokeSharp: IconWorkflowSquare03StrokeSharp,
  SolidSharp: IconWorkflowSquare03SolidSharp,
};
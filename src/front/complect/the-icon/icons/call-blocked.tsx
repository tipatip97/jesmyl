...
const d: Record<string, string> = {
  ...
  d2: 'M14.2 4.2L19.8 9.8M21 7C21 4.79086 19.2091 3 17 3C14.7909 3 13 4.79086 13 7C13 9.20914 14.7909 11 17 11C19.2091 11 21 9.20914 21 7Z',
  ...
  d6: 'M12 7C12 4.23858 14.2386 2 17 2C19.7614 2 22 4.23858 22 7C22 9.76142 19.7614 12 17 12C14.2386 12 12 9.76142 12 7ZM14.2924 5.70658C14.105 6.09822 14 6.53685 14 7C14 8.65685 15.3431 10 17 10C17.4631 10 17.9018 9.89505 18.2934 9.70763L14.2924 5.70658ZM15.7066 4.29237L19.7076 8.29342C19.895 7.90178 20 7.46315 20 7C20 5.34315 18.6569 4 17 4C16.5369 4 16.0982 4.10495 15.7066 4.29237Z',
  ...
  d8: 'M14.2001 4.19902L19.8001 9.79902M21.0001 6.99902C21.0001 4.78988 19.2092 2.99902 17.0001 2.99902C14.791 2.99902 13.0001 4.78988 13.0001 6.99902C13.0001 9.20816 14.791 10.999 17.0001 10.999C19.2092 10.999 21.0001 9.20816 21.0001 6.99902Z',
...
export const IconCallBlockedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-stroke-rounded IconCallBlockedStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallBlockedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-duotone-rounded IconCallBlockedDuotoneRounded"
    >
      <g 
...
export const IconCallBlockedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-twotone-rounded IconCallBlockedTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallBlockedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-solid-rounded IconCallBlockedSolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallBlockedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-bulk-rounded IconCallBlockedBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallBlockedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-stroke-sharp IconCallBlockedStrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallBlockedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-blocked-solid-sharp IconCallBlockedSolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallBlocked: TheIconSelfPack = {
  name: 'CallBlocked',
  StrokeRounded: IconCallBlockedStrokeRounded,
  DuotoneRounded: IconCallBlockedDuotoneRounded,
  TwotoneRounded: IconCallBlockedTwotoneRounded,
  SolidRounded: IconCallBlockedSolidRounded,
  BulkRounded: IconCallBlockedBulkRounded,
  StrokeSharp: IconCallBlockedStrokeSharp,
  SolidSharp: IconCallBlockedSolidSharp,
};
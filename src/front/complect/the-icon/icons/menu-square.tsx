...
export const IconMenuSquareDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-duotone-rounded IconMenuSquareDuotoneRounded"
    >
      <path 
...
export const IconMenuSquareTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-twotone-rounded IconMenuSquareTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconMenuSquareSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-solid-rounded IconMenuSquareSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconMenuSquareBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-bulk-rounded IconMenuSquareBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconMenuSquareStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-stroke-sharp IconMenuSquareStrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconMenuSquareSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="menu-square-solid-sharp IconMenuSquareSolidSharp"
    >
      <path 
        d={d.d13} 
        fill="var(--icon-fill)" 
...
export const iconPackOfMenuSquare: TheIconSelfPack = {
  name: 'MenuSquare',
  StrokeRounded: IconMenuSquareStrokeRounded,
  DuotoneRounded: IconMenuSquareDuotoneRounded,
  TwotoneRounded: IconMenuSquareTwotoneRounded,
  SolidRounded: IconMenuSquareSolidRounded,
  BulkRounded: IconMenuSquareBulkRounded,
  StrokeSharp: IconMenuSquareStrokeSharp,
  SolidSharp: IconMenuSquareSolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d5: 'M12.0001 14C12.5524 14 13.0001 14.4477 13.0001 15V18C13.0001 18.5523 12.5524 19 12.0001 19C11.4478 19 11.0001 18.5523 11.0001 18L11.0001 15C11.0001 14.4477 11.4478 14 12.0001 14Z',
  d6: 'M12.0001 18L12.0001 14',
  d7: 'M19.5017 22L22.0018 9L12.0018 2L2.00012 9L4.50173 22H19.5017Z',
  d8: 'M12.4319 1.38558C12.1737 1.20482 11.83 1.20481 11.5718 1.38554L1.5701 8.38554C1.32779 8.55513 1.20777 8.85129 1.26366 9.14172L3.76527 22.1417C3.83322 22.4948 4.14219 22.75 4.50176 22.75H19.5018C19.8614 22.75 20.1703 22.4948 20.2383 22.1416L22.7383 9.14164C22.7942 8.85125 22.6742 8.55515 22.4319 8.38558L12.4319 1.38558ZM13.0001 18V14H11.0001V18H13.0001Z',
};

export const IconHome02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-stroke-rounded IconHome02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconHome02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-duotone-rounded IconHome02DuotoneRounded"
    >
      <path 
...
export const IconHome02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-twotone-rounded IconHome02TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconHome02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-solid-rounded IconHome02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconHome02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-bulk-rounded IconHome02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconHome02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-stroke-sharp IconHome02StrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconHome02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="home-02-solid-sharp IconHome02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfHome02: TheIconSelfPack = {
  name: 'Home02',
  StrokeRounded: IconHome02StrokeRounded,
  DuotoneRounded: IconHome02DuotoneRounded,
  TwotoneRounded: IconHome02TwotoneRounded,
  SolidRounded: IconHome02SolidRounded,
  BulkRounded: IconHome02BulkRounded,
  StrokeSharp: IconHome02StrokeSharp,
  SolidSharp: IconHome02SolidSharp,
};
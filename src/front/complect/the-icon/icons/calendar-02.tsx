...
const d: Record<string, string> = {
  d1: 'M11 13H16M8 13H8.00898M13 17H8M16 17H15.991',
  d2: 'M18 2V4M6 2V4',
  ...
  d12: 'M11.0117 13.5H16.0117M8.01172 13.5H8.0207M13.0117 17.5H8.01172M16.0117 17.5H16.0027',
  d13: 'M3 9H21',
  ...
  d15: 'M10 12.0249H17V14.0249H10V12.0249ZM7 12.0249H9.00898V14.0249H7V12.0249ZM7 16.0249H14V18.0249H7V16.0249ZM14.991 16.0249H17V18.0249H14.991V16.0249Z',
};

export const IconCalendar02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-stroke-rounded IconCalendar02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCalendar02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-duotone-rounded IconCalendar02DuotoneRounded"
    >
      <path 
...
export const IconCalendar02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-twotone-rounded IconCalendar02TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconCalendar02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-solid-rounded IconCalendar02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconCalendar02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-bulk-rounded IconCalendar02BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconCalendar02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-stroke-sharp IconCalendar02StrokeSharp"
    >
      <path 
        d={d.d10} 
        stroke="var(--icon-stroke)" 
...
export const IconCalendar02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="calendar-02-solid-sharp IconCalendar02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfCalendar02: TheIconSelfPack = {
  name: 'Calendar02',
  StrokeRounded: IconCalendar02StrokeRounded,
  DuotoneRounded: IconCalendar02DuotoneRounded,
  TwotoneRounded: IconCalendar02TwotoneRounded,
  SolidRounded: IconCalendar02SolidRounded,
  BulkRounded: IconCalendar02BulkRounded,
  StrokeSharp: IconCalendar02StrokeSharp,
  SolidSharp: IconCalendar02SolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d8: 'M12.75 6C12.75 5.44772 13.1977 5 13.75 5L21.75 5C22.3023 5 22.75 5.44772 22.75 6C22.75 6.55228 22.3023 7 21.75 7L13.75 7C13.1977 7 12.75 6.55228 12.75 6Z',
  d9: 'M10 2H2V10H10V2Z',
  ...
  d16: 'M13.5 5H22.5V7H13.5V5Z',
};

export const IconResourcesRemoveStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-stroke-rounded IconResourcesRemoveStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconResourcesRemoveDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-duotone-rounded IconResourcesRemoveDuotoneRounded"
    >
      <path 
...
export const IconResourcesRemoveTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-twotone-rounded IconResourcesRemoveTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconResourcesRemoveSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-solid-rounded IconResourcesRemoveSolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconResourcesRemoveBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-bulk-rounded IconResourcesRemoveBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d5} 
...
export const IconResourcesRemoveStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-stroke-sharp IconResourcesRemoveStrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconResourcesRemoveSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="resources-remove-solid-sharp IconResourcesRemoveSolidSharp"
    >
      <path 
        d={d.d13} 
        fill="var(--icon-fill)" 
...
export const iconPackOfResourcesRemove: TheIconSelfPack = {
  name: 'ResourcesRemove',
  StrokeRounded: IconResourcesRemoveStrokeRounded,
  DuotoneRounded: IconResourcesRemoveDuotoneRounded,
  TwotoneRounded: IconResourcesRemoveTwotoneRounded,
  SolidRounded: IconResourcesRemoveSolidRounded,
  BulkRounded: IconResourcesRemoveBulkRounded,
  StrokeSharp: IconResourcesRemoveStrokeSharp,
  SolidSharp: IconResourcesRemoveSolidSharp,
};
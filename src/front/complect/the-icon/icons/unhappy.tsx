...
export const IconUnhappyStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-stroke-rounded IconUnhappyStrokeRounded"
    >
      <circle 
        cx="12" 
        cy="12" 
...
export const IconUnhappyDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-duotone-rounded IconUnhappyDuotoneRounded"
    >
      <circle 
...
export const IconUnhappyTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-twotone-rounded IconUnhappyTwotoneRounded"
    >
      <circle 
        cx="12" 
        cy="12" 
...
export const IconUnhappySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-solid-rounded IconUnhappySolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconUnhappyBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-bulk-rounded IconUnhappyBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconUnhappyStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-stroke-sharp IconUnhappyStrokeSharp"
    >
      <circle 
        cx="12" 
        cy="12" 
...
export const IconUnhappySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="unhappy-solid-sharp IconUnhappySolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfUnhappy: TheIconSelfPack = {
  name: 'Unhappy',
  StrokeRounded: IconUnhappyStrokeRounded,
  DuotoneRounded: IconUnhappyDuotoneRounded,
  TwotoneRounded: IconUnhappyTwotoneRounded,
  SolidRounded: IconUnhappySolidRounded,
  BulkRounded: IconUnhappyBulkRounded,
  StrokeSharp: IconUnhappyStrokeSharp,
  SolidSharp: IconUnhappySolidSharp,
};
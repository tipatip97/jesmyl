...
export const IconGoogleSheetDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-duotone-rounded IconGoogleSheetDuotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconGoogleSheetTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-twotone-rounded IconGoogleSheetTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconGoogleSheetSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-solid-rounded IconGoogleSheetSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconGoogleSheetBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-bulk-rounded IconGoogleSheetBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d6} 
...
export const IconGoogleSheetStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-stroke-sharp IconGoogleSheetStrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconGoogleSheetSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="google-sheet-solid-sharp IconGoogleSheetSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfGoogleSheet: TheIconSelfPack = {
  name: 'GoogleSheet',
  StrokeRounded: IconGoogleSheetStrokeRounded,
  DuotoneRounded: IconGoogleSheetDuotoneRounded,
  TwotoneRounded: IconGoogleSheetTwotoneRounded,
  SolidRounded: IconGoogleSheetSolidRounded,
  BulkRounded: IconGoogleSheetBulkRounded,
  StrokeSharp: IconGoogleSheetStrokeSharp,
  SolidSharp: IconGoogleSheetSolidSharp,
};
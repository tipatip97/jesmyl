...
const d: Record<string, string> = {
  ...
  d3: 'M14 4.5L22 4.5M14 4.5C14 3.79977 15.9943 2.49153 16.5 2M14 4.5C14 5.20023 15.9943 6.50847 16.5 7',
...
export const IconMessageIncoming01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-duotone-rounded IconMessageIncoming01DuotoneRounded"
    >
      <path 
...
export const IconMessageIncoming01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-twotone-rounded IconMessageIncoming01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconMessageIncoming01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-solid-rounded IconMessageIncoming01SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconMessageIncoming01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-bulk-rounded IconMessageIncoming01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconMessageIncoming01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-stroke-sharp IconMessageIncoming01StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconMessageIncoming01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="message-incoming-01-solid-sharp IconMessageIncoming01SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfMessageIncoming01: TheIconSelfPack = {
  name: 'MessageIncoming01',
  StrokeRounded: IconMessageIncoming01StrokeRounded,
  DuotoneRounded: IconMessageIncoming01DuotoneRounded,
  TwotoneRounded: IconMessageIncoming01TwotoneRounded,
  SolidRounded: IconMessageIncoming01SolidRounded,
  BulkRounded: IconMessageIncoming01BulkRounded,
  StrokeSharp: IconMessageIncoming01StrokeSharp,
  SolidSharp: IconMessageIncoming01SolidSharp,
};
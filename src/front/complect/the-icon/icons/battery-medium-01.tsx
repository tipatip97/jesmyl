...
export const IconBatteryMedium01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-duotone-rounded IconBatteryMedium01DuotoneRounded"
    >
      <path 
...
export const IconBatteryMedium01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-twotone-rounded IconBatteryMedium01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryMedium01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-solid-rounded IconBatteryMedium01SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBatteryMedium01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-bulk-rounded IconBatteryMedium01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconBatteryMedium01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-stroke-sharp IconBatteryMedium01StrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryMedium01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-medium-01-solid-sharp IconBatteryMedium01SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfBatteryMedium01: TheIconSelfPack = {
  name: 'BatteryMedium01',
  StrokeRounded: IconBatteryMedium01StrokeRounded,
  DuotoneRounded: IconBatteryMedium01DuotoneRounded,
  TwotoneRounded: IconBatteryMedium01TwotoneRounded,
  SolidRounded: IconBatteryMedium01SolidRounded,
  BulkRounded: IconBatteryMedium01BulkRounded,
  StrokeSharp: IconBatteryMedium01StrokeSharp,
  SolidSharp: IconBatteryMedium01SolidSharp,
};
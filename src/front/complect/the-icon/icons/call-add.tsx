...
const d: Record<string, string> = {
  ...
  d8: 'M17.0001 2.99951V10.9995M21.0001 6.99951H13.0001',
  ...
  d11: 'M16 6V3H18V6L21 6V8H18V11H16V8H13V6L16 6Z',
};

export const IconCallAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-stroke-rounded IconCallAddStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-duotone-rounded IconCallAddDuotoneRounded"
    >
      <g 
...
export const IconCallAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-twotone-rounded IconCallAddTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-solid-rounded IconCallAddSolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-bulk-rounded IconCallAddBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-stroke-sharp IconCallAddStrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-add-solid-sharp IconCallAddSolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallAdd: TheIconSelfPack = {
  name: 'CallAdd',
  StrokeRounded: IconCallAddStrokeRounded,
  DuotoneRounded: IconCallAddDuotoneRounded,
  TwotoneRounded: IconCallAddTwotoneRounded,
  SolidRounded: IconCallAddSolidRounded,
  BulkRounded: IconCallAddBulkRounded,
  StrokeSharp: IconCallAddStrokeSharp,
  SolidSharp: IconCallAddSolidSharp,
};
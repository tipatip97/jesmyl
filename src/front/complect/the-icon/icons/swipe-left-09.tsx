...
const d: Record<string, string> = {
  ...
  d2: 'M15.5 4.5H22M15.5 4.5C15.5 3.79977 17.4943 2.49153 18 2M15.5 4.5C15.5 5.20023 17.4943 6.50847 18 7',
  ...
  d5: 'M21.75 3.49414C22.3023 3.49414 22.75 3.94186 22.75 4.49414C22.75 5.04643 22.3023 5.49414 21.75 5.49414L19.25 5.49414L19.25 6.0884C19.2501 6.26404 19.2503 6.47969 19.2282 6.65613L19.2278 6.65947C19.212 6.78592 19.1402 7.36196 18.5746 7.63632C18.0078 7.91128 17.5076 7.60935 17.3994 7.54403L16.931 7.20489C16.5551 6.91025 16.0407 6.50455 15.6497 6.12412C15.4546 5.93429 15.2533 5.71703 15.0945 5.48612C14.9533 5.28086 14.75 4.93067 14.75 4.5C14.75 4.06933 14.9533 3.71914 15.0945 3.51388C15.2533 3.28297 15.4546 3.06571 15.6497 2.87588C16.0407 2.49545 16.5551 2.08975 16.9309 1.79512L17.3994 1.45597C17.5076 1.39065 18.0078 1.08872 18.5746 1.36368C19.1402 1.63804 19.212 2.21408 19.2278 2.34053L19.2282 2.34387C19.2503 2.52031 19.2501 2.73597 19.25 2.9116L19.25 3.49414L21.75 3.49414Z',
  ...
  d7: 'M22 4.5H16.3046M18 2L15.5 4.5L18 7',
  ...
  d9: 'M18.043 1.75L14.8359 4.95711L18.043 8.16421L19.4573 6.75L18.6644 5.95711H22.7502V3.95711H18.6644L19.4573 3.16421L18.043 1.75Z',
};

export const IconSwipeLeft09StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSwipeLeft09SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}

...
const d: Record<string, string> = {
  ...
  d5: 'M12 6.5C12.5523 6.5 13 6.94772 13 7.5V10H15.5C16.0523 10 16.5 10.4477 16.5 11C16.5 11.5523 16.0523 12 15.5 12H13V14.5C13 15.0523 12.5523 15.5 12 15.5C11.4477 15.5 11 15.0523 11 14.5V12H8.5C7.94772 12 7.5 11.5523 7.5 11C7.5 10.4477 7.94772 10 8.5 10H11L11 7.5C11 6.94772 11.4477 6.5 12 6.5Z',
  d6: 'M21 11C21 18 12 22 12 22C12 22 3 18 3 11C3 6.02944 7.02944 2 12 2C16.9706 2 21 6.02944 21 11Z',
  d7: 'M16 11H12M12 11H8M12 11V15M12 11L12 7',
  d8: 'M10.2203 21.8483C10.6562 22.0977 11.0206 22.2874 11.2779 22.4156L12 22.75L12.7221 22.4156C12.9794 22.2874 13.3438 22.0977 13.7797 21.8483C14.6496 21.3505 15.813 20.6101 16.9801 19.6407C19.2892 17.7227 21.75 14.7912 21.75 10.968C21.75 5.60091 17.3848 1.25 12 1.25C6.61522 1.25 2.25 5.60091 2.25 10.968C2.25 14.7912 4.71077 17.7227 7.01986 19.6407C8.18703 20.6101 9.35038 21.3505 10.2203 21.8483ZM11 15V12H8V10H11V7H13V10H16V12H13V15H11Z',
};

export const IconLocationAdd01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-stroke-rounded IconLocationAdd01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconLocationAdd01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-duotone-rounded IconLocationAdd01DuotoneRounded"
    >
      <path 
...
export const IconLocationAdd01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-twotone-rounded IconLocationAdd01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconLocationAdd01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-solid-rounded IconLocationAdd01SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconLocationAdd01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-bulk-rounded IconLocationAdd01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconLocationAdd01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-stroke-sharp IconLocationAdd01StrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconLocationAdd01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="location-add-01-solid-sharp IconLocationAdd01SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfLocationAdd01: TheIconSelfPack = {
  name: 'LocationAdd01',
  StrokeRounded: IconLocationAdd01StrokeRounded,
  DuotoneRounded: IconLocationAdd01DuotoneRounded,
  TwotoneRounded: IconLocationAdd01TwotoneRounded,
  SolidRounded: IconLocationAdd01SolidRounded,
  BulkRounded: IconLocationAdd01BulkRounded,
  StrokeSharp: IconLocationAdd01StrokeSharp,
  SolidSharp: IconLocationAdd01SolidSharp,
};
...
export const IconNeutralStrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralDuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralTwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralSolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralBulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralStrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconNeutralSolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}

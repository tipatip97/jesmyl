...
export const IconBatteryFullDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-duotone-rounded IconBatteryFullDuotoneRounded"
    >
      <path 
...
export const IconBatteryFullTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-twotone-rounded IconBatteryFullTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryFullSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-solid-rounded IconBatteryFullSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBatteryFullBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-bulk-rounded IconBatteryFullBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconBatteryFullStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-stroke-sharp IconBatteryFullStrokeSharp"
    >
      <path 
        d={d.d10} 
        stroke="var(--icon-stroke)" 
...
export const IconBatteryFullSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="battery-full-solid-sharp IconBatteryFullSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfBatteryFull: TheIconSelfPack = {
  name: 'BatteryFull',
  StrokeRounded: IconBatteryFullStrokeRounded,
  DuotoneRounded: IconBatteryFullDuotoneRounded,
  TwotoneRounded: IconBatteryFullTwotoneRounded,
  SolidRounded: IconBatteryFullSolidRounded,
  BulkRounded: IconBatteryFullBulkRounded,
  StrokeSharp: IconBatteryFullStrokeSharp,
  SolidSharp: IconBatteryFullSolidSharp,
};
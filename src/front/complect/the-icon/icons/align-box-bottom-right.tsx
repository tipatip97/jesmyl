...
const d: Record<string, string> = {
  ...
  d5: 'M9 11C8.44772 11 8 11.4477 8 12C8 12.5523 8.44772 13 9 13H17C17.5523 13 18 12.5523 18 12C18 11.4477 17.5523 11 17 11H9ZM14 16C13.4477 16 13 16.4477 13 17C13 17.5523 13.4477 18 14 18H17C17.5523 18 18 17.5523 18 17C18 16.4477 17.5523 16 17 16H14Z',
  d6: 'M3 22L3 2L21 2.01302L21 22H3Z',
  d7: 'M7 12H17M12 17H17',
  d8: 'M2.99946 1.25635C2.58545 1.25665 2.25 1.59235 2.25 2.00635V21.9933C2.25 22.4075 2.58579 22.7433 3 22.7433L21 22.7498C21.4142 22.7498 21.75 22.414 21.75 21.9998V2.01282C21.75 1.59882 21.4145 1.26312 21.0005 1.26282L2.99946 1.25635ZM7 12.9999H17V10.9999H7V12.9999ZM12 17.9999H17V15.9999H12V17.9999Z',
};

export const IconAlignBoxBottomRightStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-stroke-rounded IconAlignBoxBottomRightStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconAlignBoxBottomRightDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-duotone-rounded IconAlignBoxBottomRightDuotoneRounded"
    >
      <path 
...
export const IconAlignBoxBottomRightTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-twotone-rounded IconAlignBoxBottomRightTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxBottomRightSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-solid-rounded IconAlignBoxBottomRightSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconAlignBoxBottomRightBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-bulk-rounded IconAlignBoxBottomRightBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconAlignBoxBottomRightStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-stroke-sharp IconAlignBoxBottomRightStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxBottomRightSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-bottom-right-solid-sharp IconAlignBoxBottomRightSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfAlignBoxBottomRight: TheIconSelfPack = {
  name: 'AlignBoxBottomRight',
  StrokeRounded: IconAlignBoxBottomRightStrokeRounded,
  DuotoneRounded: IconAlignBoxBottomRightDuotoneRounded,
  TwotoneRounded: IconAlignBoxBottomRightTwotoneRounded,
  SolidRounded: IconAlignBoxBottomRightSolidRounded,
  BulkRounded: IconAlignBoxBottomRightBulkRounded,
  StrokeSharp: IconAlignBoxBottomRightStrokeSharp,
  SolidSharp: IconAlignBoxBottomRightSolidSharp,
};
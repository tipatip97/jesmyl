...
const d: Record<string, string> = {
  ...
  d2: 'M12.5 4.51385L14.8787 6.95844C15.8787 7.98615 16.3787 8.5 17 8.5C17.6213 8.5 18.1213 7.98615 19.1213 6.95844L22 4M15.5 4.20705C14.8432 4.19772 12.6682 3.74589 12.2071 4.20705C11.7459 4.66821 12.1977 6.84324 12.2071 7.5',
  ...
  d11: 'M11 3H16.5V5H14.4142L17 7.58578L21.2929 3.29289L22.7071 4.70711L17.7071 9.70711C17.5196 9.89464 17.2652 10 17 10C16.7348 10 16.4804 9.89464 16.2929 9.70711L13 6.41422V8.5H11V3Z',
};

export const IconCallMissed01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-stroke-rounded IconCallMissed01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallMissed01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-duotone-rounded IconCallMissed01DuotoneRounded"
    >
      <g 
...
export const IconCallMissed01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-twotone-rounded IconCallMissed01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallMissed01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-solid-rounded IconCallMissed01SolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallMissed01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-bulk-rounded IconCallMissed01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallMissed01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-stroke-sharp IconCallMissed01StrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallMissed01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-missed-01-solid-sharp IconCallMissed01SolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallMissed01: TheIconSelfPack = {
  name: 'CallMissed01',
  StrokeRounded: IconCallMissed01StrokeRounded,
  DuotoneRounded: IconCallMissed01DuotoneRounded,
  TwotoneRounded: IconCallMissed01TwotoneRounded,
  SolidRounded: IconCallMissed01SolidRounded,
  BulkRounded: IconCallMissed01BulkRounded,
  StrokeSharp: IconCallMissed01StrokeSharp,
  SolidSharp: IconCallMissed01SolidSharp,
};
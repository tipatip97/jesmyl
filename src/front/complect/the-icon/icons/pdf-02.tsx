...
const d: Record<string, string> = {
  ...
  d5: 'M8.01565 12.25C8.02714 12.25 8.0386 12.25 8.05002 12.25H8.75002C9.85421 12.25 10.8125 13.1114 10.8125 14.25C10.8125 15.3886 9.85421 16.25 8.75002 16.25H7.75002V18C7.75002 18.4142 7.41423 18.75 7.00002 18.75C6.58581 18.75 6.25002 18.4142 6.25002 18V14C6.25002 13.9883 6.25002 13.9766 6.25001 13.9647C6.24992 13.7605 6.24982 13.5363 6.27661 13.3465C6.30854 13.1203 6.39077 12.8374 6.63655 12.6034C6.87717 12.3742 7.15902 12.3025 7.3787 12.2744C7.57026 12.2499 7.7985 12.2499 8.01565 12.25ZM7.75002 14.75H8.75002C9.09558 14.75 9.31252 14.4921 9.31252 14.25C9.31252 14.0079 9.09558 13.75 8.75002 13.75H8.05002C7.92879 13.75 7.83325 13.7501 7.75123 13.7518C7.75006 13.8209 7.75002 13.9008 7.75002 14V14.75Z',
...
export const IconPdf02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-stroke-rounded IconPdf02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconPdf02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-duotone-rounded IconPdf02DuotoneRounded"
    >
      <path 
...
export const IconPdf02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-twotone-rounded IconPdf02TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconPdf02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-solid-rounded IconPdf02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconPdf02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-bulk-rounded IconPdf02BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconPdf02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-stroke-sharp IconPdf02StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconPdf02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="pdf-02-solid-sharp IconPdf02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfPdf02: TheIconSelfPack = {
  name: 'Pdf02',
  StrokeRounded: IconPdf02StrokeRounded,
  DuotoneRounded: IconPdf02DuotoneRounded,
  TwotoneRounded: IconPdf02TwotoneRounded,
  SolidRounded: IconPdf02SolidRounded,
  BulkRounded: IconPdf02BulkRounded,
  StrokeSharp: IconPdf02StrokeSharp,
  SolidSharp: IconPdf02SolidSharp,
};
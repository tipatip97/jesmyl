...
const d: Record<string, string> = {
  ...
  d5: 'M7 8.5C6.44771 8.5 6 8.94772 6 9.5C6 10.0523 6.44771 10.5 7 10.5H15C15.5523 10.5 16 10.0523 16 9.5C16 8.94772 15.5523 8.5 15 8.5H7ZM7 13.5C6.44771 13.5 6 13.9477 6 14.5C6 15.0523 6.44771 15.5 7 15.5H10C10.5523 15.5 11 15.0523 11 14.5C11 13.9477 10.5523 13.5 10 13.5H7Z',
...
export const IconBorderFullStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-stroke-rounded IconBorderFullStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconBorderFullDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-duotone-rounded IconBorderFullDuotoneRounded"
    >
      <path 
...
export const IconBorderFullTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-twotone-rounded IconBorderFullTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconBorderFullSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-solid-rounded IconBorderFullSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconBorderFullBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-bulk-rounded IconBorderFullBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconBorderFullStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-stroke-sharp IconBorderFullStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconBorderFullSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="border-full-solid-sharp IconBorderFullSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfBorderFull: TheIconSelfPack = {
  name: 'BorderFull',
  StrokeRounded: IconBorderFullStrokeRounded,
  DuotoneRounded: IconBorderFullDuotoneRounded,
  TwotoneRounded: IconBorderFullTwotoneRounded,
  SolidRounded: IconBorderFullSolidRounded,
  BulkRounded: IconBorderFullBulkRounded,
  StrokeSharp: IconBorderFullStrokeSharp,
  SolidSharp: IconBorderFullSolidSharp,
};
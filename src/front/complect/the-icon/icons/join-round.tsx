...
export const IconJoinRoundStrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundDuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundTwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundSolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundBulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundStrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconJoinRoundSolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}

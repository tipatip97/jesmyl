...
export const IconHdr02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-duotone-rounded IconHdr02DuotoneRounded"
    >
      <path 
...
export const IconHdr02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-twotone-rounded IconHdr02TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconHdr02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-solid-rounded IconHdr02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconHdr02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-bulk-rounded IconHdr02BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconHdr02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-stroke-sharp IconHdr02StrokeSharp"
    >
      <path 
        d={d.d7} 
        stroke="var(--icon-stroke)" 
...
export const IconHdr02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hdr-02-solid-sharp IconHdr02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfHdr02: TheIconSelfPack = {
  name: 'Hdr02',
  StrokeRounded: IconHdr02StrokeRounded,
  DuotoneRounded: IconHdr02DuotoneRounded,
  TwotoneRounded: IconHdr02TwotoneRounded,
  SolidRounded: IconHdr02SolidRounded,
  BulkRounded: IconHdr02BulkRounded,
  StrokeSharp: IconHdr02StrokeSharp,
  SolidSharp: IconHdr02SolidSharp,
};
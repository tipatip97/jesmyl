...
const d: Record<string, string> = {
  ...
  d3: 'M12.4626 6L11.0685 7.81238C10.9192 8.0066 11.0262 8.28605 11.2698 8.33776L12.7301 8.64772C12.9898 8.70285 13.0889 9.01223 12.9073 9.2011L11.1777 11',
  ...
  d6: 'M13.0714 5.46521C13.5092 5.80193 13.5911 6.42977 13.2544 6.86754L12.5091 7.83656L12.9369 7.92738C13.9319 8.13858 14.3753 9.37408 13.6273 10.152L11.8977 11.9509C11.515 12.3491 10.8819 12.3615 10.4838 11.9787C10.0857 11.5959 10.0733 10.9629 10.456 10.5648L11.3499 9.63507L11.0614 9.57383C10.1296 9.37604 9.65746 8.26355 10.2751 7.46057L11.6691 5.64819C12.0058 5.21042 12.6337 5.1285 13.0714 5.46521Z',
  d7: 'M20 14.5V2.5L4 2.5V14.5',
  d8: 'M2 21.5L4.01911 14.5H19.9514L21.9996 21.5H2Z',
  d9: 'M11.5 12L13.5 8.5H10.5L12.5 5',
  ...
  d11: 'M12.2237 7.50005L13.3688 5.49618L11.6323 4.50391L8.77734 9.50005H11.7773L10.6323 11.5039L12.3688 12.4962L15.2237 7.50005H12.2237Z',
};

export const IconLaptopChargingStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-stroke-rounded IconLaptopChargingStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconLaptopChargingDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-duotone-rounded IconLaptopChargingDuotoneRounded"
    >
      <path 
...
export const IconLaptopChargingTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-twotone-rounded IconLaptopChargingTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconLaptopChargingSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-solid-rounded IconLaptopChargingSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconLaptopChargingBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-bulk-rounded IconLaptopChargingBulkRounded"
    >
      <path 
        opacity="0.3" 
        fillRule="evenodd" 
...
export const IconLaptopChargingStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-stroke-sharp IconLaptopChargingStrokeSharp"
    >
      <path 
        d={d.d7} 
        stroke="var(--icon-stroke)" 
...
export const IconLaptopChargingSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="laptop-charging-solid-sharp IconLaptopChargingSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfLaptopCharging: TheIconSelfPack = {
  name: 'LaptopCharging',
  StrokeRounded: IconLaptopChargingStrokeRounded,
  DuotoneRounded: IconLaptopChargingDuotoneRounded,
  TwotoneRounded: IconLaptopChargingTwotoneRounded,
  SolidRounded: IconLaptopChargingSolidRounded,
  BulkRounded: IconLaptopChargingBulkRounded,
  StrokeSharp: IconLaptopChargingStrokeSharp,
  SolidSharp: IconLaptopChargingSolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d6: 'M14 2C14.5523 2 15 2.44772 15 3V10C15 10.5523 14.5523 11 14 11C13.4477 11 13 10.5523 13 10V3C13 2.44772 13.4477 2 14 2ZM20 2C20.5523 2 21 2.44772 21 3V10C21 10.5523 20.5523 11 20 11C19.4477 11 19 10.5523 19 10V3C19 2.44772 19.4477 2 20 2Z',
  ...
  d8: 'M18.9996 2.99902V9.99902M13.9996 2.99902V9.99902',
  ...
  d11: 'M13 10V3H15V10H13ZM18 10V3H20V10H18Z',
};

export const IconCallPausedStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-stroke-rounded IconCallPausedStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallPausedDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-duotone-rounded IconCallPausedDuotoneRounded"
    >
      <g 
...
export const IconCallPausedTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-twotone-rounded IconCallPausedTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallPausedSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-solid-rounded IconCallPausedSolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallPausedBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-bulk-rounded IconCallPausedBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallPausedStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-stroke-sharp IconCallPausedStrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallPausedSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-paused-solid-sharp IconCallPausedSolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallPaused: TheIconSelfPack = {
  name: 'CallPaused',
  StrokeRounded: IconCallPausedStrokeRounded,
  DuotoneRounded: IconCallPausedDuotoneRounded,
  TwotoneRounded: IconCallPausedTwotoneRounded,
  SolidRounded: IconCallPausedSolidRounded,
  BulkRounded: IconCallPausedBulkRounded,
  StrokeSharp: IconCallPausedStrokeSharp,
  SolidSharp: IconCallPausedSolidSharp,
};
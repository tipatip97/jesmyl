...
export const IconGithubDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-duotone-rounded IconGithubDuotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconGithubTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-twotone-rounded IconGithubTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconGithubSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-solid-rounded IconGithubSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconGithubBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-bulk-rounded IconGithubBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d5} 
...
export const IconGithubStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-stroke-sharp IconGithubStrokeSharp"
    >
      <path 
        d={d.d7} 
        stroke="var(--icon-stroke)" 
...
export const IconGithubSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="github-solid-sharp IconGithubSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfGithub: TheIconSelfPack = {
  name: 'Github',
  StrokeRounded: IconGithubStrokeRounded,
  DuotoneRounded: IconGithubDuotoneRounded,
  TwotoneRounded: IconGithubTwotoneRounded,
  SolidRounded: IconGithubSolidRounded,
  BulkRounded: IconGithubBulkRounded,
  StrokeSharp: IconGithubStrokeSharp,
  SolidSharp: IconGithubSolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d2: 'M21 5.5L13 5.5M21 5.5C21 6.20023 19.0057 7.50847 18.5 8M21 5.5C21 4.79977 19.0057 3.49153 18.5 3',
  ...
  d8: 'M13.0001 5.99902H20.6596M18.0001 8.99902L21.0001 5.99902L18.0001 2.99902',
  ...
  d11: 'M18.5858 5.00008L17.2929 3.70718L18.7071 2.29297L22.4142 6.00008L18.7071 9.70718L17.2929 8.29297L18.5858 7.00008L13 7.00008V5.00008L18.5858 5.00008Z',
};

export const IconCallOutgoing01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-stroke-rounded IconCallOutgoing01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCallOutgoing01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-duotone-rounded IconCallOutgoing01DuotoneRounded"
    >
      <g 
...
export const IconCallOutgoing01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-twotone-rounded IconCallOutgoing01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCallOutgoing01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-solid-rounded IconCallOutgoing01SolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconCallOutgoing01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-bulk-rounded IconCallOutgoing01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconCallOutgoing01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-stroke-sharp IconCallOutgoing01StrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconCallOutgoing01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="call-outgoing-01-solid-sharp IconCallOutgoing01SolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCallOutgoing01: TheIconSelfPack = {
  name: 'CallOutgoing01',
  StrokeRounded: IconCallOutgoing01StrokeRounded,
  DuotoneRounded: IconCallOutgoing01DuotoneRounded,
  TwotoneRounded: IconCallOutgoing01TwotoneRounded,
  SolidRounded: IconCallOutgoing01SolidRounded,
  BulkRounded: IconCallOutgoing01BulkRounded,
  StrokeSharp: IconCallOutgoing01StrokeSharp,
  SolidSharp: IconCallOutgoing01SolidSharp,
};
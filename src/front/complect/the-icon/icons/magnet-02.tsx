...
export const IconMagnet02StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-stroke-rounded IconMagnet02StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconMagnet02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-duotone-rounded IconMagnet02DuotoneRounded"
    >
      <path 
...
export const IconMagnet02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-twotone-rounded IconMagnet02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconMagnet02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-solid-rounded IconMagnet02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconMagnet02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-bulk-rounded IconMagnet02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d6} 
...
export const IconMagnet02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-stroke-sharp IconMagnet02StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconMagnet02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="magnet-02-solid-sharp IconMagnet02SolidSharp"
    >
      <path 
        d={d.d10} 
        fill="var(--icon-fill)" 
...
export const iconPackOfMagnet02: TheIconSelfPack = {
  name: 'Magnet02',
  StrokeRounded: IconMagnet02StrokeRounded,
  DuotoneRounded: IconMagnet02DuotoneRounded,
  TwotoneRounded: IconMagnet02TwotoneRounded,
  SolidRounded: IconMagnet02SolidRounded,
  BulkRounded: IconMagnet02BulkRounded,
  StrokeSharp: IconMagnet02StrokeSharp,
  SolidSharp: IconMagnet02SolidSharp,
};
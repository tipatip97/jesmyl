...
export const IconSentStrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentDuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentTwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentSolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentBulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentStrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconSentSolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}

...
export const IconSettings03DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-duotone-rounded IconSettings03DuotoneRounded"
    >
      <path 
...
export const IconSettings03TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-twotone-rounded IconSettings03TwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconSettings03SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-solid-rounded IconSettings03SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconSettings03BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-bulk-rounded IconSettings03BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d5} 
...
export const IconSettings03StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-stroke-sharp IconSettings03StrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconSettings03SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="settings-03-solid-sharp IconSettings03SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfSettings03: TheIconSelfPack = {
  name: 'Settings03',
  StrokeRounded: IconSettings03StrokeRounded,
  DuotoneRounded: IconSettings03DuotoneRounded,
  TwotoneRounded: IconSettings03TwotoneRounded,
  SolidRounded: IconSettings03SolidRounded,
  BulkRounded: IconSettings03BulkRounded,
  StrokeSharp: IconSettings03StrokeSharp,
  SolidSharp: IconSettings03SolidSharp,
};
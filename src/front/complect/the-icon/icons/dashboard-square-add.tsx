...
const d: Record<string, string> = {
  ...
  d8: 'M18 1.5C18.5523 1.5 19 1.94772 19 2.5V5L21.5 5C22.0523 5 22.5 5.44772 22.5 6C22.5 6.55228 22.0523 7 21.5 7H19V9.5C19 10.0523 18.5523 10.5 18 10.5C17.4477 10.5 17 10.0523 17 9.5V7H14.5C13.9477 7 13.5 6.55228 13.5 6C13.5 5.44771 13.9477 5 14.5 5L17 5V2.5C17 1.94772 17.4477 1.5 18 1.5Z',
  d9: 'M18 1.5V10.5M22.5 6L13.5 6',
  d10: 'M10 2H2V10H10V2Z',
  d11: 'M10 14H2V22H10V14Z',
  d12: 'M22 14H14V22H22V14Z',
  d13: 'M17 5V1.5H19V5H22.5V7H19V10.5H17V7H13.5V5H17Z',
...
export const IconDashboardSquareAddStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-stroke-rounded IconDashboardSquareAddStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconDashboardSquareAddDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-duotone-rounded IconDashboardSquareAddDuotoneRounded"
    >
      <path 
...
export const IconDashboardSquareAddTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-twotone-rounded IconDashboardSquareAddTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconDashboardSquareAddSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-solid-rounded IconDashboardSquareAddSolidRounded"
    >
      <path 
        d={d.d5} 
        fill="var(--icon-fill)" 
...
export const IconDashboardSquareAddBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-bulk-rounded IconDashboardSquareAddBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d5} 
...
export const IconDashboardSquareAddStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-stroke-sharp IconDashboardSquareAddStrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconDashboardSquareAddSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dashboard-square-add-solid-sharp IconDashboardSquareAddSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfDashboardSquareAdd: TheIconSelfPack = {
  name: 'DashboardSquareAdd',
  StrokeRounded: IconDashboardSquareAddStrokeRounded,
  DuotoneRounded: IconDashboardSquareAddDuotoneRounded,
  TwotoneRounded: IconDashboardSquareAddTwotoneRounded,
  SolidRounded: IconDashboardSquareAddSolidRounded,
  BulkRounded: IconDashboardSquareAddBulkRounded,
  StrokeSharp: IconDashboardSquareAddStrokeSharp,
  SolidSharp: IconDashboardSquareAddSolidSharp,
};
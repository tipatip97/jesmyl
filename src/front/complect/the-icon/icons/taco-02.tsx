...
export const IconTaco02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-duotone-rounded IconTaco02DuotoneRounded"
    >
      <path 
...
export const IconTaco02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-twotone-rounded IconTaco02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconTaco02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-solid-rounded IconTaco02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconTaco02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-bulk-rounded IconTaco02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d6} 
...
export const IconTaco02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-stroke-sharp IconTaco02StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconTaco02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="taco-02-solid-sharp IconTaco02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfTaco02: TheIconSelfPack = {
  name: 'Taco02',
  StrokeRounded: IconTaco02StrokeRounded,
  DuotoneRounded: IconTaco02DuotoneRounded,
  TwotoneRounded: IconTaco02TwotoneRounded,
  SolidRounded: IconTaco02SolidRounded,
  BulkRounded: IconTaco02BulkRounded,
  StrokeSharp: IconTaco02StrokeSharp,
  SolidSharp: IconTaco02SolidSharp,
};
...
const d: Record<string, string> = {
  d1: 'M14.1588 21.4146C14.3031 21.4699 14.4585 21.5 14.6203 21.5C15.385 21.5 16.0049 20.8284 16.0049 20C16.0049 19.1716 15.385 18.5 14.6203 18.5C14.3488 18.5 14.0956 18.5846 13.8819 18.7309C12.8207 19.5225 10.8549 20.5378 8.62023 20.801M5.85102 20.6936C5.2328 20.5635 4.61355 20.3541 4.00488 20.0478',
  d2: 'M19.0049 20.5C19.263 20.5 19.9606 20.5 21.0049 20.5',
...
export const IconCloudFastWindDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-duotone-rounded IconCloudFastWindDuotoneRounded"
    >
      <path 
...
export const IconCloudFastWindTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-twotone-rounded IconCloudFastWindTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d8} 
...
export const IconCloudFastWindSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-solid-rounded IconCloudFastWindSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconCloudFastWindBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-bulk-rounded IconCloudFastWindBulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconCloudFastWindStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-stroke-sharp IconCloudFastWindStrokeSharp"
    >
      <path 
        d={d.d13} 
        stroke="var(--icon-stroke)" 
...
export const IconCloudFastWindSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cloud-fast-wind-solid-sharp IconCloudFastWindSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfCloudFastWind: TheIconSelfPack = {
  name: 'CloudFastWind',
  StrokeRounded: IconCloudFastWindStrokeRounded,
  DuotoneRounded: IconCloudFastWindDuotoneRounded,
  TwotoneRounded: IconCloudFastWindTwotoneRounded,
  SolidRounded: IconCloudFastWindSolidRounded,
  BulkRounded: IconCloudFastWindBulkRounded,
  StrokeSharp: IconCloudFastWindStrokeSharp,
  SolidSharp: IconCloudFastWindSolidSharp,
};
...
export const IconCoupon03StrokeRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03DuotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03TwotoneRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03SolidRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03BulkRounded = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03StrokeSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}
...
export const IconCoupon03SolidSharp = (props: TheIconProps) => {
  return (
    <TheIconWrapper
      {...props}

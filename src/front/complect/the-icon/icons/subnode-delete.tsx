...
const d: Record<string, string> = {
  d1: 'M14.5 19.5H13.5C10.6716 19.5 9.25736 19.5 8.37868 18.6213C7.5 17.7426 7.5 16.3284 7.5 13.5V11.5M7.5 8V11.5M7.5 11.5H12.5',
  ...
  d4: 'M19.5 9.5L17.5 11.5M17.5 11.5L15.5 13.5M17.5 11.5L19.5 13.5M17.5 11.5L15.5 9.5',
  d5: 'M7.5 7C8.05229 7 8.5 7.44772 8.5 8V10.5H12.5C13.0523 10.5 13.5 10.9477 13.5 11.5C13.5 12.0523 13.0523 12.5 12.5 12.5H8.5V13.5C8.5 14.9425 8.50213 15.9237 8.60092 16.6586C8.69585 17.3646 8.86322 17.6916 9.08579 17.9142C9.30836 18.1368 9.63538 18.3042 10.3414 18.3991C11.0763 18.4979 12.0575 18.5 13.5 18.5H14.5C15.0523 18.5 15.5 18.9477 15.5 19.5C15.5 20.0523 15.0523 20.5 14.5 20.5L13.4294 20.5C12.0753 20.5 10.9587 20.5001 10.0749 20.3812C9.14711 20.2565 8.32768 19.9845 7.67158 19.3284C7.01547 18.6723 6.7435 17.8529 6.61875 16.9251C6.49994 16.0413 6.49997 14.9247 6.5 13.5706L6.5 8C6.5 7.44772 6.94772 7 7.5 7Z',
  d6: 'M14.7929 8.79289C15.1834 8.40237 15.8166 8.40237 16.2071 8.79289L17.5 10.0858L18.7929 8.79289C19.1834 8.40237 19.8166 8.40237 20.2071 8.79289C20.5976 9.18342 20.5976 9.81658 20.2071 10.2071L18.9142 11.5L20.2071 12.7929C20.5976 13.1834 20.5976 13.8166 20.2071 14.2071C19.8166 14.5976 19.1834 14.5976 18.7929 14.2071L17.5 12.9142L16.2071 14.2071C15.8166 14.5976 15.1834 14.5976 14.7929 14.2071C14.4024 13.8166 14.4024 13.1834 14.7929 12.7929L16.0858 11.5L14.7929 10.2071C14.4024 9.81658 14.4024 9.18342 14.7929 8.79289Z',
  ...
  d16: 'M17.5001 12.9143L18.793 14.2072L20.2072 12.793L18.9143 11.5001L20.2072 10.2072L18.793 8.79297L17.5001 10.0859L16.2072 8.79297L14.793 10.2072L16.0859 11.5001L14.793 12.793L16.2072 14.2072L17.5001 12.9143Z',
};

export const IconSubnodeDeleteStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-stroke-rounded IconSubnodeDeleteStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconSubnodeDeleteDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-duotone-rounded IconSubnodeDeleteDuotoneRounded"
    >
      <path 
...
export const IconSubnodeDeleteTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-twotone-rounded IconSubnodeDeleteTwotoneRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d1} 
...
export const IconSubnodeDeleteSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-solid-rounded IconSubnodeDeleteSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconSubnodeDeleteBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-bulk-rounded IconSubnodeDeleteBulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconSubnodeDeleteStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-stroke-sharp IconSubnodeDeleteStrokeSharp"
    >
      <path 
        d={d.d10} 
        stroke="var(--icon-stroke)" 
...
export const IconSubnodeDeleteSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="subnode-delete-solid-sharp IconSubnodeDeleteSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfSubnodeDelete: TheIconSelfPack = {
  name: 'SubnodeDelete',
  StrokeRounded: IconSubnodeDeleteStrokeRounded,
  DuotoneRounded: IconSubnodeDeleteDuotoneRounded,
  TwotoneRounded: IconSubnodeDeleteTwotoneRounded,
  SolidRounded: IconSubnodeDeleteSolidRounded,
  BulkRounded: IconSubnodeDeleteBulkRounded,
  StrokeSharp: IconSubnodeDeleteStrokeSharp,
  SolidSharp: IconSubnodeDeleteSolidSharp,
};
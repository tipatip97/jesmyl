...
export const IconDeliverySent01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-duotone-rounded IconDeliverySent01DuotoneRounded"
    >
      <path 
...
export const IconDeliverySent01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-twotone-rounded IconDeliverySent01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconDeliverySent01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-solid-rounded IconDeliverySent01SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconDeliverySent01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-bulk-rounded IconDeliverySent01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d7} 
...
export const IconDeliverySent01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-stroke-sharp IconDeliverySent01StrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconDeliverySent01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="delivery-sent-01-solid-sharp IconDeliverySent01SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfDeliverySent01: TheIconSelfPack = {
  name: 'DeliverySent01',
  StrokeRounded: IconDeliverySent01StrokeRounded,
  DuotoneRounded: IconDeliverySent01DuotoneRounded,
  TwotoneRounded: IconDeliverySent01TwotoneRounded,
  SolidRounded: IconDeliverySent01SolidRounded,
  BulkRounded: IconDeliverySent01BulkRounded,
  StrokeSharp: IconDeliverySent01StrokeSharp,
  SolidSharp: IconDeliverySent01SolidSharp,
};
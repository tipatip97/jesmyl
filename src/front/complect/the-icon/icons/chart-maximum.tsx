...
export const IconChartMaximumStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-stroke-rounded IconChartMaximumStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconChartMaximumDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-duotone-rounded IconChartMaximumDuotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconChartMaximumTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-twotone-rounded IconChartMaximumTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconChartMaximumSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-solid-rounded IconChartMaximumSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconChartMaximumBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-bulk-rounded IconChartMaximumBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconChartMaximumStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-stroke-sharp IconChartMaximumStrokeSharp"
    >
      <path 
        d={d.d8} 
        stroke="var(--icon-stroke)" 
...
export const IconChartMaximumSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="chart-maximum-solid-sharp IconChartMaximumSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfChartMaximum: TheIconSelfPack = {
  name: 'ChartMaximum',
  StrokeRounded: IconChartMaximumStrokeRounded,
  DuotoneRounded: IconChartMaximumDuotoneRounded,
  TwotoneRounded: IconChartMaximumTwotoneRounded,
  SolidRounded: IconChartMaximumSolidRounded,
  BulkRounded: IconChartMaximumBulkRounded,
  StrokeSharp: IconChartMaximumStrokeSharp,
  SolidSharp: IconChartMaximumSolidSharp,
};
...
const d: Record<string, string> = {
  ...
  d2: 'M18.85 18.85L17.5 17.95V15.7M13 17.5C13 19.9853 15.0147 22 17.5 22C19.9853 22 22 19.9853 22 17.5C22 15.0147 19.9853 13 17.5 13C15.0147 13 13 15.0147 13 17.5Z',
  ...
  d9: 'M19 19L17.5 17.95V15M13 17.5C13 19.9853 15.0147 22 17.5 22C19.9853 22 22 19.9853 22 17.5C22 15.0147 19.9853 13 17.5 13C15.0147 13 13 15.0147 13 17.5Z',
  d10: 'M21 11.5V5.5H2V21H11',
  d11: 'M16 5.5L15 2H8L7 5.5',
  d12: 'M17.5 12.25C14.6005 12.25 12.25 14.6005 12.25 17.5C12.25 20.3995 14.6005 22.75 17.5 22.75C20.3995 22.75 22.75 20.3995 22.75 17.5C22.75 14.6005 20.3995 12.25 17.5 12.25ZM18.25 15V17.5595L19.4301 18.3856L18.5699 19.6144L16.75 18.3405V15H18.25Z',
...
export const IconWorkHistoryStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-stroke-rounded IconWorkHistoryStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconWorkHistoryDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-duotone-rounded IconWorkHistoryDuotoneRounded"
    >
      <path 
...
export const IconWorkHistoryTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-twotone-rounded IconWorkHistoryTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconWorkHistorySolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-solid-rounded IconWorkHistorySolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconWorkHistoryBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-bulk-rounded IconWorkHistoryBulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconWorkHistoryStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-stroke-sharp IconWorkHistoryStrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconWorkHistorySolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="work-history-solid-sharp IconWorkHistorySolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfWorkHistory: TheIconSelfPack = {
  name: 'WorkHistory',
  StrokeRounded: IconWorkHistoryStrokeRounded,
  DuotoneRounded: IconWorkHistoryDuotoneRounded,
  TwotoneRounded: IconWorkHistoryTwotoneRounded,
  SolidRounded: IconWorkHistorySolidRounded,
  BulkRounded: IconWorkHistoryBulkRounded,
  StrokeSharp: IconWorkHistoryStrokeSharp,
  SolidSharp: IconWorkHistorySolidSharp,
};
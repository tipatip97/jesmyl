...
const d: Record<string, string> = {
  ...
  d5: 'M7 6C6.44772 6 6 6.44772 6 7C6 7.55228 6.44772 8 7 8H15C15.5523 8 16 7.55228 16 7C16 6.44772 15.5523 6 15 6H7ZM7 11C6.44772 11 6 11.4477 6 12C6 12.5523 6.44772 13 7 13H10C10.5523 13 11 12.5523 11 12C11 11.4477 10.5523 11 10 11H7Z',
  d6: 'M3 22L3 2L21 2.01302L21 22H3Z',
  d7: 'M17 7L7 7M12 12H7',
  d8: 'M2.99946 1.25635C2.58545 1.25665 2.25 1.59235 2.25 2.00635V21.9933C2.25 22.4075 2.58579 22.7433 3 22.7433L21 22.7498C21.4142 22.7498 21.75 22.414 21.75 21.9998V2.01282C21.75 1.59882 21.4145 1.26312 21.0005 1.26282L2.99946 1.25635ZM17 5.99988H7V7.99988H17V5.99988ZM12 10.9999H7V12.9999H12V10.9999Z',
};

export const IconAlignBoxTopLeftStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-stroke-rounded IconAlignBoxTopLeftStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconAlignBoxTopLeftDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-duotone-rounded IconAlignBoxTopLeftDuotoneRounded"
    >
      <path 
...
export const IconAlignBoxTopLeftTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-twotone-rounded IconAlignBoxTopLeftTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxTopLeftSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-solid-rounded IconAlignBoxTopLeftSolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconAlignBoxTopLeftBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-bulk-rounded IconAlignBoxTopLeftBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconAlignBoxTopLeftStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-stroke-sharp IconAlignBoxTopLeftStrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconAlignBoxTopLeftSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="align-box-top-left-solid-sharp IconAlignBoxTopLeftSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfAlignBoxTopLeft: TheIconSelfPack = {
  name: 'AlignBoxTopLeft',
  StrokeRounded: IconAlignBoxTopLeftStrokeRounded,
  DuotoneRounded: IconAlignBoxTopLeftDuotoneRounded,
  TwotoneRounded: IconAlignBoxTopLeftTwotoneRounded,
  SolidRounded: IconAlignBoxTopLeftSolidRounded,
  BulkRounded: IconAlignBoxTopLeftBulkRounded,
  StrokeSharp: IconAlignBoxTopLeftStrokeSharp,
  SolidSharp: IconAlignBoxTopLeftSolidSharp,
};
...
export const IconFile01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-stroke-rounded IconFile01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconFile01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-duotone-rounded IconFile01DuotoneRounded"
    >
      <path 
...
export const IconFile01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-twotone-rounded IconFile01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconFile01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-solid-rounded IconFile01SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconFile01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-bulk-rounded IconFile01BulkRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconFile01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-stroke-sharp IconFile01StrokeSharp"
    >
      <path 
        d={d.d9} 
        stroke="var(--icon-stroke)" 
...
export const IconFile01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="file-01-solid-sharp IconFile01SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfFile01: TheIconSelfPack = {
  name: 'File01',
  StrokeRounded: IconFile01StrokeRounded,
  DuotoneRounded: IconFile01DuotoneRounded,
  TwotoneRounded: IconFile01TwotoneRounded,
  SolidRounded: IconFile01SolidRounded,
  BulkRounded: IconFile01BulkRounded,
  StrokeSharp: IconFile01StrokeSharp,
  SolidSharp: IconFile01SolidSharp,
};
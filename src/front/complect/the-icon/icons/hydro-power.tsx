...
const d: Record<string, string> = {
  ...
  d2: 'M8 12.7551C8 10.8722 9.68508 9.01158 10.8678 7.9375C11.5102 7.35417 12.4898 7.35417 13.1322 7.9375C14.3149 9.01158 16 10.8722 16 12.7551C16 14.6012 14.4853 16.5 12 16.5C9.51472 16.5 8 14.6012 8 12.7551Z',
  d3: 'M12.0801 22C6.513 22 2 17.5228 2 12C2 6.47715 6.513 2 12.0801 2C16.3104 2 19.9321 4.58521 21.4274 8.25C22.3182 10.6378 22.8299 16.3845 17.7501 20.2691C16.1346 21.3614 14.1825 22 12.0801 22ZM10.8678 7.9375C9.68508 9.01158 8 10.8722 8 12.7551C8 14.6012 9.51472 16.5 12 16.5C14.4853 16.5 16 14.6012 16 12.7551C16 10.8722 14.3149 9.01158 13.1322 7.9375C12.4898 7.35417 11.5102 7.35417 10.8678 7.9375Z',
  ...
  d14: 'M12 7.5C12 7.5 8 10 8 12.7551C8 14.6012 9.51472 16.5 12 16.5C14.4853 16.5 16 14.6012 16 12.7551C16 10 12 7.5 12 7.5Z',
...
export const IconHydroPowerStrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-stroke-rounded IconHydroPowerStrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconHydroPowerDuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-duotone-rounded IconHydroPowerDuotoneRounded"
    >
      <path 
...
export const IconHydroPowerTwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-twotone-rounded IconHydroPowerTwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconHydroPowerSolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-solid-rounded IconHydroPowerSolidRounded"
    >
      <path 
        d={d.d4} 
        fill="var(--icon-fill)" 
...
export const IconHydroPowerBulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-bulk-rounded IconHydroPowerBulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d8} 
...
export const IconHydroPowerStrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-stroke-sharp IconHydroPowerStrokeSharp"
    >
      <path 
        d={d.d13} 
        stroke="var(--icon-stroke)" 
...
export const IconHydroPowerSolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="hydro-power-solid-sharp IconHydroPowerSolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfHydroPower: TheIconSelfPack = {
  name: 'HydroPower',
  StrokeRounded: IconHydroPowerStrokeRounded,
  DuotoneRounded: IconHydroPowerDuotoneRounded,
  TwotoneRounded: IconHydroPowerTwotoneRounded,
  SolidRounded: IconHydroPowerSolidRounded,
  BulkRounded: IconHydroPowerBulkRounded,
  StrokeSharp: IconHydroPowerStrokeSharp,
  SolidSharp: IconHydroPowerSolidSharp,
};
...
export const IconDollarReceive02DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-duotone-rounded IconDollarReceive02DuotoneRounded"
    >
      <path 
...
export const IconDollarReceive02TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-twotone-rounded IconDollarReceive02TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconDollarReceive02SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-solid-rounded IconDollarReceive02SolidRounded"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const IconDollarReceive02BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-bulk-rounded IconDollarReceive02BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        fillRule="evenodd" 
...
export const IconDollarReceive02StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-stroke-sharp IconDollarReceive02StrokeSharp"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconDollarReceive02SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="dollar-receive-02-solid-sharp IconDollarReceive02SolidSharp"
    >
      <path 
        fillRule="evenodd" 
        clipRule="evenodd" 
...
export const iconPackOfDollarReceive02: TheIconSelfPack = {
  name: 'DollarReceive02',
  StrokeRounded: IconDollarReceive02StrokeRounded,
  DuotoneRounded: IconDollarReceive02DuotoneRounded,
  TwotoneRounded: IconDollarReceive02TwotoneRounded,
  SolidRounded: IconDollarReceive02SolidRounded,
  BulkRounded: IconDollarReceive02BulkRounded,
  StrokeSharp: IconDollarReceive02StrokeSharp,
  SolidSharp: IconDollarReceive02SolidSharp,
};
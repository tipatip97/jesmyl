...
const d: Record<string, string> = {
  ...
  d2: 'M15 7H19M17 9V5M22 7C22 9.76142 19.7614 12 17 12C14.2386 12 12 9.76142 12 7C12 4.23858 14.2386 2 17 2C19.7614 2 22 4.23858 22 7Z',
  ...
  d9: 'M17 1.25C13.8244 1.25 11.25 3.82436 11.25 7C11.25 10.1756 13.8244 12.75 17 12.75C20.1756 12.75 22.75 10.1756 22.75 7C22.75 3.82436 20.1756 1.25 17 1.25ZM18 9.5V8H19.5V6H18V4.5H16V6H14.5V8H16V9.5H18Z',
};

export const IconCursorAddSelection01StrokeRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-stroke-rounded IconCursorAddSelection01StrokeRounded"
    >
      <path 
        d={d.d1} 
...
export const IconCursorAddSelection01DuotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-duotone-rounded IconCursorAddSelection01DuotoneRounded"
    >
      <path 
...
export const IconCursorAddSelection01TwotoneRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-twotone-rounded IconCursorAddSelection01TwotoneRounded"
    >
      <path 
        d={d.d1} 
        stroke="var(--icon-stroke)" 
...
export const IconCursorAddSelection01SolidRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-solid-rounded IconCursorAddSelection01SolidRounded"
    >
      <path 
        d={d.d4} 
        fill="var(--icon-fill)" 
...
export const IconCursorAddSelection01BulkRounded: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-bulk-rounded IconCursorAddSelection01BulkRounded"
    >
      <path 
        opacity="var(--icon-opacity)" 
        d={d.d4} 
...
export const IconCursorAddSelection01StrokeSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-stroke-sharp IconCursorAddSelection01StrokeSharp"
    >
      <path 
        d={d.d6} 
        stroke="var(--icon-stroke)" 
...
export const IconCursorAddSelection01SolidSharp: FC<TheIconProps> = (props: TheIconProps): JSX.Element => {
  return (
    <TheIconWrapper
      {...props}
      name="cursor-add-selection-01-solid-sharp IconCursorAddSelection01SolidSharp"
    >
      <path 
        d={d.d8} 
        fill="var(--icon-fill)" 
...
export const iconPackOfCursorAddSelection01: TheIconSelfPack = {
  name: 'CursorAddSelection01',
  StrokeRounded: IconCursorAddSelection01StrokeRounded,
  DuotoneRounded: IconCursorAddSelection01DuotoneRounded,
  TwotoneRounded: IconCursorAddSelection01TwotoneRounded,
  SolidRounded: IconCursorAddSelection01SolidRounded,
  BulkRounded: IconCursorAddSelection01BulkRounded,
  StrokeSharp: IconCursorAddSelection01StrokeSharp,
  SolidSharp: IconCursorAddSelection01SolidSharp,
};
...
export default function StrongDropdown<
  Storage extends ExerStorage,
  Id extends string | number,
  Item extends DropdownItem<Id> = DropdownItem<Id>,
>({ scope, fieldName, cud, mapExecArgs, fieldKey, fieldValue, ...props }: StrongControlProps<DropdownProps<Id, Item>>) {

...
export type FreeExecDictAntiCallback<Value> = (
  exec: Exec<Value>,
) =>
  | (<Key extends keyof typeof FreeExecDictAntiCallbackStrategy>(
      strategy: typeof FreeExecDictAntiCallbackStrategy,
    ) => (typeof FreeExecDictAntiCallbackStrategy)[Key] | nil)
  | void
  | nil;
...
export interface ClientExecutionDict<Value = any, Args = any>
  extends FreeExecDict<Value, Args>,
    ExecutionDict<Value, Args> {
  method?: ExecutionMethod;
  corrects?: CorrectsBox;
}

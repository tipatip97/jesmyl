...
export default function useIsExpand(initIsExpand: boolean, prefix?: ReactNode, postfix?: ReactNode | ((isExpand: boolean) => ReactNode)): [ReactNode, boolean, (isExpand?: boolean) => void] {

...
export const useAliasCurrentTeam = <RetMode extends 'index' | 'team'>(returnMode: RetMode, state: GamerAliasRoomState | und, memberList: string[] | und): (RetMode extends 'index' ? number : AliasGameTeam) | null => {
    return useMemo(() => {

...
export default function PasswordTyping({ setIsOpen, setTitle }: { setIsOpen: (is: boolean) => void, setTitle: (title: string) => void }) {
    ...
    useEffect(() => { setIsOpen(isShow && isTyping) }, [isShow, isTyping, setIsOpen]);

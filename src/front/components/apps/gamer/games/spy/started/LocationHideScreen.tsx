...
export default function LocationHideScreen(props: Props) {
    ...
    return <div className="full-width flex center column margin-b ig-gap-h">
        <HideScreen
        ...
        >
            <div
                className={'hidden-screen relative text-center'
                    + (props.isAllSpiesFound ? ' bgcolor--7 color--5' : ' bgcolor--2')}
            >
                <div className="relative">
                    {props.isAllSpiesFound
                        ? 'Больше шпионов нет'
                        : 'Твоя локация'}
                </div>
        ...
        <BottomControls className="full-width">
            ...
            >
                {isTouchDevice
                    ? <FingerprintScreen setIsOpen={setIsOpen} setTitle={setTitle} />
                    : <PasswordTyping setIsOpen={setIsOpen} setTitle={setTitle} />}
            </PassControl>

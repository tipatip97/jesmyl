...
export default function CmExternalComListAtt({
    ...
    const [comOrderNode, openComOrder] = useFullContent(() => {
        ...
        const uniqRemovedComws = comws === undefined
            ? removedComws
            : removedComws.filter(comw => !comws.includes(comw));

        return <div className="margin-giant-gap-t">
                    ...
                    description={
                        <div className="flex flex-gap">
                            ...
                            <StrongEvaButton
                                ...
                                onSuccess={
                                    removedComws.includes(comw)
                                        ? undefined
                                        : () => setRemovedComws(comws => [...comws, comw])
                                }
                                className="color--ko"
                            />
                        </div>
    ...
    const [selectorNode] = useFullContent(() => {
        return <div className="flex column full-height">
            <EvaButton
                name="sync"

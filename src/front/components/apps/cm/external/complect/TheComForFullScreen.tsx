...
export default function TheComForFullScreen({
  ...
  return (
    <div ref={comListElem} className="absolute full-width full-height over-y-auto pos-top pos-left">
      <TheControlledCom com={com} chordVisibleVariant={chordVisibleVariant} comList={comList} onComSet={onComSet} />
    </div>
  );
}

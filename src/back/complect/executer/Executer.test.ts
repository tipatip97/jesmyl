...
describe('Executer', () => {
  ...
  it('isExpected', () => {
    ...
    expect(Executer.isExpected({}, ['{*level}', 'in', '{arr}'], { arr: [131, 94, 300, 87] }, { level: 300 })).toBe(
      true,
    );
    expect(Executer.isExpected({}, ['{*level}', 'out', '{arr}'], { arr: [131, 94, 3030, 87] }, { level: 300 })).toBe(
      true,
    );

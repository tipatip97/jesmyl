...
import { AliasGameTeam, AliasWordsPack, GamerAliasRoomState, GamerAliasRoomStatePhase, StartAliasRoundProps } from "./alias.model";
    ...
    '<phases>': {
        ...
        '<compute score>': {
            ...
            side: (props) => {
                ...
                const aliasWordPacks = AliasHelp.getTokenizedWordInfos(state.token, state.dicts, state.lens, getWordPacks(), getNounPronsWords());
